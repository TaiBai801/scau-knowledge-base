<template>
  <div class="ardot-page-hero">
    <div class="ardot-page-inner">
      ...
      <h1>贡献指南</h1>
      <p>投稿课程资料·学习经验·纠错建议<br>让你的知识帮助更多学弟学妹</p>
    </div>
  </div>
    ...
    <div class="ardot-page-inner">
      <div class="ardot-steps">
        <div class="ardot-step">
          ...
          <h3>整理资料</h3>
          <p>课件 PDF / 复习笔记 / 历年真题 / 学习方法 — 任何对学弟学妹有用的内容</p>
        </div>
        <div class="ardot-step">
        ...
        <div class="ardot-step">
          ...
          <h3>等待审核</h3>
          <p>管理员 1-3 天内审核格式和内容，纳入对应课程页面</p>
        </div>
        <div class="ardot-step">
          <div class="ardot-step-num">4</div>
          <h3>全院共享</h3>
          <p>审核通过后，资料自动同步到 EdgeOne CDN，全院学生随时访问</p>
        </div>
      </div>
      ...
      <div class="ardot-contribute-methods">
        ...
        <div class="ardot-method-grid">
          <a href="mailto:2286318767@qq.com" class="ardot-method">
            ...
            <span class="ardot-method-hint">附件不超过 50MB</span>
          </a>
          ...
          <a href="https://github.com/TaiBai801/scau-knowledge-base" class="ardot-method" target="_blank">
            ...
            <h3>GitHub PR</h3>
            <p>开发者友好</p>
            <span class="ardot-method-hint">Pull Request 方式</span>
          </a>
        </div>
      </div>
